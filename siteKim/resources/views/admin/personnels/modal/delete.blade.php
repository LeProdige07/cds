...
<div class="modal fade" id="ModalDelete{{ $personnel->id }}" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">Voulez-vous supprimer le personnel <b>{{ $personnel->names }}</b> ? </div>
